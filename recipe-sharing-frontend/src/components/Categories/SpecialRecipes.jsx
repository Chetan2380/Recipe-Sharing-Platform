                            ...
                            >
                                ...
                                <div className="special-recipe-details">
                                    ...
                                    <div className="special-cooking-time-container">
                                        <p className="special-recipe-cooking-time"><i className="fa-regular fa-clock"></i>&nbsp;&nbsp;{recipe.cookingTime}</p>
                                    </div>
                                    <div className="special-rating-container">
                                        <p className="special-recipe-rating"><i className="fa-solid fa-star"></i>&nbsp;&nbsp;{recipe.averageRating ? recipe.averageRating : 'NA'}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
