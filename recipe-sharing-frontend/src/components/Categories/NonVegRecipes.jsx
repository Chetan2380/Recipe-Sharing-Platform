                                ...
                                >
                                    ...
                                    <div className="non-veg-recipe-details">
                                        ...
                                        <div className="non-veg-cooking-time-container">
                                            <p className="non-veg-recipe-cooking-time"><i className="fa-regular fa-clock"></i>&nbsp;&nbsp;{recipe.cookingTime}</p>
                                        </div>
                                        <div className="non-veg-rating-container">
                                            <p className="non-veg-recipe-rating"><i className="fa-solid fa-star"></i>&nbsp;&nbsp;{recipe.averageRating ? recipe.averageRating : 'NA'}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
