                            ...
                            >
                                ...
                                <div className="vegan-recipe-details">
                                    ...
                                    <div className="vegan-cooking-time-container">
                                        <p className="vegan-recipe-cooking-time"><i className="fa-regular fa-clock"></i>&nbsp;&nbsp;{recipe.cookingTime}</p>
                                    </div>
                                    <div className="vegan-rating-container">
                                        <p className="vegan-recipe-rating"><i className="fa-solid fa-star"></i>&nbsp;&nbsp;{recipe.averageRating ? recipe.averageRating : 'NA'}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
