                            ...
                            >
                                ...
                                <div className="veg-recipe-details">
                                    ...
                                    <div className="veg-cooking-time-container">
                                        <p className="veg-recipe-cooking-time"><i className="fa-regular fa-clock"></i>&nbsp;&nbsp;{recipe.cookingTime}</p>
                                    </div>
                                    <div className="veg-rating-container">
                                        <p className="veg-recipe-rating"><i className="fa-solid fa-star"></i>&nbsp;&nbsp;{recipe.averageRating ? recipe.averageRating : 'NA'}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
